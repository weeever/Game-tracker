...
contextBridge.exposeInMainWorld('questlog', {
    ...
    showAndCenterWindow: () => ipcRenderer.invoke('show-and-center-window'),
    ...
    fetchSteamSchema: (apiKey, appId, lang) => ipcRenderer.invoke('fetch-steam-schema', apiKey, appId, lang),
    fetchSteamPlaytime: (apiKey, steamId, appId) => ipcRenderer.invoke('fetch-steam-playtime', apiKey, steamId, appId),
    fetchPublicSteamSchema: (appId, lang) => ipcRenderer.invoke('fetch-public-steam-schema', appId, lang),
    ...
    checkLocalAchievements: (appId, exePath) => ipcRenderer.invoke('check-local-achievements', appId, exePath),
